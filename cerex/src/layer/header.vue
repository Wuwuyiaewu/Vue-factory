...
<div class="header_inside">	
	...
	<div class="main_menu">
		<ul>
			...
			<li class="<!--#if expr='$menu_select = 2' -->select<!--#endif --> sub_hide">
				<p onClick="mobile_submenu($(this))">产品
					<svg id="icon" x="0px" y="0px" viewBox="0 0 100 100" 	xml:space="preserve">
						<polygon class="st0" points="93.48,30.98 50,39.18 6.52,30.98 50,76.9 "/>
					</svg>
				</p>
				<ul>
			...
			<li class="<!--#if expr='$menu_select = 3' -->select<!--#endif -->">
				<a href="platform.html">平台下载</a>
			</li>
			<li class="<!--#if expr='$menu_select = 4' -->select<!--#endif --> sub_hide">
				<p onClick="mobile_submenu($(this))">资讯中心
					<svg id="icon" x="0px" y="0px" viewBox="0 0 100 100" 	xml:space="preserve">
						<polygon class="st0" points="93.48,30.98 50,39.18 6.52,30.98 50,76.9 "/>
					</svg>
				</p>
				<ul>
					<li><a href="news.html">新闻评论</a></li>
					<li><a href="calendar.html">财经日历</a></li>
					<li><a href="learningcentre.html">教学中心</a></li>
					<li><a href="questions.html">常见问题</a></li>
					<li><a href="announcement.html">最新公告</a></li>
				</ul>
			</li>
			<li class="<!--#if expr='$menu_select = 5' -->select<!--#endif --> sub_hide">
				<p onClick="mobile_submenu($(this))">公司简介
					<svg id="icon" x="0px" y="0px" viewBox="0 0 100 100" 	xml:space="preserve">
						<polygon class="st0" points="93.48,30.98 50,39.18 6.52,30.98 50,76.9 "/>
					</svg>
				</p>
...
<path class="st0" d="M15.08,36.69c0,8.96,4.15,15.42,11.48,18.01v26.99L33.67,90h10.94V79.58l-3.28-2.59v-0.34l3.28-3.11V69.3
	...
	V50.95l-1.87-0.46C21.25,48.41,20,40.95,19.99,36.69z"/>
            ...
            <a href="#" class="btn2"><svg  x="0px" y="0px" viewBox="0 0 100 100" >
