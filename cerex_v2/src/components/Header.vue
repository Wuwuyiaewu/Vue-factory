<template>
  ...
  <div class="header" id="header">
      ...
      <div class="main_menu">
        <ul>
          ...
          <li
            ...
            "
          >
            <p @click="mobile_submenu('product_list')" class="product_list">
              产品
              <svg
                id="icon"
                x="0px"
              ...
              >
                <polygon
                  class="st0"
                  points="93.48,30.98 50,39.18 6.52,30.98 50,76.9 "
                />
              </svg>
            </p>
            <ul>
              <li><a href="products_overview.html">产品概览</a></li>
              <li><a href="agreement.html">合约细则</a></li>
              <li><a href="transaction.html">交易安排</a></li>
              <li>
                <a
                  href="@/assets/images/products/Cerex_expiry_date.pdf"
                  target="_blank"
                  >合约到期日</a
                >
              </li>
              <li><a href="products_details.html">产品优势</a></li>
            </ul>
          </li>
          <li class="<!--#if expr='$menu_select = 3' -->select<!--#endif -->">
            <a href="download.html">平台下载</a>
          </li>
          <li
            class="
              <!--#if
            ...
            "
          >
            <p @click="mobile_submenu('info_list')" class="info_list">
              资讯中心
              <svg
                id="icon"
                x="0px"
            ...
            <ul>
              <li><a href="news_comment.html">新闻评论</a></li>
              <li><a href="calendar.html">财经日历</a></li>
              <li><a href="teaching_center.html">教学中心</a></li>
              <li><a href="qna.html">常见问题</a></li>
          ...
          <li
            ...
            "
          >
            <p @click="mobile_submenu('com_list')" class="com_list">
              公司简介
              <svg
                id="icon"
                x="0px"
            ...
            <ul>
              <li><a href="about_us.html">品牌故事</a></li>
              <li><a href="contact_us.html">联系我们</a></li>
              <li><a href="event.html">优惠活动</a></li>
            </ul>
          </li>
        </ul>
        ...
        <div class="top_right">
          <a href="#" class="btn1"
            ><svg x="0px" y="0px" viewBox="0 0 100 100">
              <path
                class="st0"
                d="M15.08,36.69c0,8.96,4.15,15.42,11.48,18.01v26.99L33.67,90h10.94V79.58l-3.28-2.59v-0.34l3.28-3.11V69.3
	...
	V50.95l-1.87-0.46C21.25,48.41,20,40.95,19.99,36.69z"
          ...
          <a href="#" class="btn2"
            ><svg x="0px" y="0px" viewBox="0 0 100 100">
              <path
                class="st0"
                d="M60.72,52.04C76.19,56.69,87.35,71.15,87.84,88h-4.51C82.74,69.92,68.31,54.98,50,54.98
	...
	c-9.1,0-16.48,7.38-16.48,16.48c0,9.11,7.37,16.48,16.48,16.48c9.1,0,16.48-7.38,16.48-16.48C66.48,24.88,59.11,17.51,50,17.51z"
          ...
          <a href="#" class="btn4"
            ><img src="@/assets/images/mobile_cs.png"
          /></a>
          <p class="mobile_menu" @click="show_mobile_menu">
    ...
    <div class="right_menu">
      <a href="#">
        <svg x="0px" y="0px" viewBox="0 0 40 40">
          ...
          <path
            class="st0"
            d="M17.92,17.06c0-1.97,2.48-4.04,3.63-5.23c0.98-1.01,0.89-2.72-0.32-3.57c-0.72-0.5-1.68-0.53-2.42-0.05
		...
		c-0.39,0-0.8-0.33-0.8-0.73v-2.21H17.92z"
          ...
          <path
            class="st0"
            d="M14.04,36c-0.21,0-0.43-0.04-0.64-0.12c-0.65-0.26-1.07-0.88-1.07-1.59V31H9.81C7.74,31,6,29.17,6,27V16.84
      ...
      <a href="#">
        <svg x="0px" y="0px" viewBox="0 0 40 40">
          <path
            class="st0"
            d="M6,14.56c0,3.6,1.65,6.2,4.56,7.25v10.85L13.38,36h4.34v-4.18l-1.3-1.04v-0.14l1.3-1.25v-1.71l-1.3-1.49V26
	...
	l-1.3,1.25v1.95l1.3,1.04v1.24h-1.49l-1.77-2.1V20.29l-0.74-0.19C8.62,19.31,7.95,16.65,7.95,14.56z"
      ...
      <a href="#">
        <svg x="0px" y="0px" viewBox="0 0 40 40">
          <path
            class="st0"
            d="M24.53,20.66C31.07,22.64,35.79,28.81,36,36h-1.91C33.84,28.29,27.74,21.91,20,21.91
	...
	c0,3.89,3.12,7.03,6.97,7.03c3.85,0,6.97-3.15,6.97-7.03C26.97,9.07,23.85,5.93,20,5.93z"
      ...
      <a href="#">
        <svg x="0px" y="0px" viewBox="0 0 40 40">
          <g>
            <path
              class="st0"
              d="M12.95,7.16c-0.55,0-0.99,0.44-0.99,0.99s0.44,0.99,0.99,0.99h5.21c0.55,0,0.99-0.44,0.99-0.99
			s-0.44-0.99-0.99-0.99H12.95z"
            />
            <path
              class="st0"
              d="M24.14,29.73H7.99V7.74c0-0.97,0.79-1.75,1.75-1.75H21.4c0.87,0,1.62,0.66,1.73,1.54
            ...
            <path
              class="st0"
              d="M24.48,10.03c-5.19,0-9.42,4.22-9.42,9.42c0,1.72,0.46,3.38,1.34,4.85l-0.64,2.67
            ...
            <path
              class="st0"
              d="M27.37,19.25l-2.13,2.28v-6.35c0-0.49-0.4-0.89-0.89-0.89c-0.49,0-0.89,0.4-0.89,0.89v6.35l-2.13-2.28
      ...
      <p onClick="back_top()">
        <svg
          ...
          xml:space="preserve"
        >
          <polygon points="25,13 37.499,24 50,35 25,35 0,35 12.5,24 " />
        </svg>
      </p>
    </div>
  </div>
  ...
  methods: {
    show_mobile_menu() {
      ...
      var this_height =
        $(window).height() -
        $("#header").outerHeight() -
        $(".mobile_menu_btn").outerHeight();
      $(".main_menu>ul").css({
        "max-height": this_height + "px",
      });
    },
    mobile_submenu(this_o) {
