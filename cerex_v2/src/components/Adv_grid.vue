  ...
  <div class="teaching_pic_list">
    <div class="left_menu list2 wow fadeInLeft">
      ...
      <p v-if="sideLink.length">
          <router-link v-for="i of sideLink" :key="i.id" :to="{ path: `/learningcentre/advanced/detail/${i.id}.html` }">{{ i.title }}</router-link>
        </p>
        <router-link
          :to="{ path: `/learningcentre/advanced.html` }"
          class="more"
          >更多&gt;</router-link
        >
    </div>
    <div class="right_pic wow fadeIn">
      <div class="big_pic" v-if="listLinkFirst.length">
          <router-link :to="{ path: `/learningcentre/advanced/detail/${listLinkFirst[0].id}.html` }"></router-link>
          <span 
      ...
      <div class="s_pic_group">
        <div class="s_pic" v-for="item of listLinkFour" :key="item.id">
            <router-link :to="{ path: `/learningcentre/advanced/detail/${item.id}.html` }"></router-link>
            <span
