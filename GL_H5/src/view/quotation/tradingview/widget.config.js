...
export function WidgetConfig (style, resolveConfig) {
    let options = {
        ...
        custom_css_url: 'customCssUrl.css?v=1.0.3',
        locale: 'zh',
        ...
        overrides: {
            ...
            'scalesProperties.lineColor': '#E8E8EA',
            // 'scalesProperties.textColor': '#E8E8EA',
    ...
    if (typeof resolveConfig === 'function') {
        const temp = resolveConfig(options)
        if (temp) {
            options = temp
        }
    }
